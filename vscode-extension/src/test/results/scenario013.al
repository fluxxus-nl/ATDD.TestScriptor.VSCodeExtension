codeunit 50100 "TestObjectFLX"
{
    ...
    begin
        ...
        // [THEN] Valid Then
        VerifyValidThen();
        // [Then] new then all lowercase
        VerifyNewThenAllLowercase();
    end;
    ...
    local procedure VerifyNewThenAllLowercase()
    begin
        Error('Procedure VerifyNewThenAllLowercase not yet implemented.');
    end;
}